...
stdenv.mkDerivation {
  ...
  outputHash = "0hd7969zdwzsyp5dsjlxhpg23byk1i05n2bb42sfr793pvc5g20d";
  ...
  meta = with lib; {
    ...
    longDescription = ''
      ...
      Rubik is a 5 weight Roman + Italic family. Rubik Mono One is paired with Rubik
      One, a proportionally spaced variation of the design.
